            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            <!-- Logo -->
                            <div class="shrink-0 flex items-center" v-if="$page.props.auth.roles.includes('admin')">
                            ...
                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" v-if="$page.props.auth.roles.includes('admin')">
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" v-if="$page.props.auth.roles.includes('admin')"
                    class="sm:hidden">

<template>
    ...
    <AuthenticatedLayout>
      <div
        class="user-page grid grid-cols-1 lg:grid-cols-4 gap-4 p-4"
      ...
      >
        ...
        <div class="col-span-1 lg:col-span-3 border rounded-xl shadow-xl">
          <div class="pb-2 p-4">
            ...
            <div class="flex flex-wrap justify-between items-center">
              ...
              <div class="inline-flex items-center rounded-md mr-2 mb-1 w-full md:w-auto">
                <InputText
                  id="contact_id"
                  v-model="localAddress.contact_id"
                  placeholder="Contact ID"
                  class="w-full !border-black"
                  :disabled="isFieldLocked('contact_id')"
                />
              </div>
            </div>
          </div>
                ...
                <template #content>
                  <div class="grid grid-cols-1 mx-3 gap-4">
                    <div class="field">
                      ...
                      <InputText
                        id="company_name"
                        v-model="localAddress.company_name"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                      <div class="field">
                        ...
                        <InputText
                          id="salutation"
                          v-model="localAddress.salutation"
                          class="w-full !border-secondary"
                      ...
                      <div class="field md:col-span-2">
                        ...
                        <InputText
                          id="first_name"
                          v-model="localAddress.first_name"
                          class="w-full !border-secondary"
                      ...
                      <div class="field md:col-span-2">
                        ...
                        <InputText
                          id="last_name"
                          v-model="localAddress.last_name"
                          class="w-full !border-secondary"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div class="field">
                        ...
                        <InputText
                          id="phone_number"
                          v-model="localAddress.phone_number"
                          class="w-full !border-secondary"
                      ...
                      <div class="field">
                        <label
                          for="email_address_system"
                          class="font-extrabold text-lg"
                        >
                          Email Address: <span class="text-red-600">*</span>
                        </label>
                        <InputText
                          id="email_address_system"
                  ...
                  <div class="grid">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div class="field">
                        ...
                        <Textarea
                          id="interest_notes"
                          v-model="logdata.interest_notes"
                          rows="5"
                          class="w-full !border-secondary"
                        />
                      </div>
                    ...
                    <div class="field">
                      ...
                      <Textarea
                        id="personal_notes"
                        v-model="logdata.personal_notes"
                        rows="2"
                        class="w-full !border-secondary"
                      />
                    </div>
          ...
          <div class="flex flex-col lg:flex-row justify-center my-4">
            <button
              @click="notreached = true; submitFeedback()"
            ...
            >
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
              <path d="M1.60718 1.66168V18.2422H25.4797V1.66168" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M17.5222 22.8817L13.5434 26.8604L9.5647 22.8817" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M13.5435 18.2398V26.8604" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M16.1885 5.62616L19.5116 8.95604L16.1885 12.3315" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <template #content>
                ...
                >
                  ...
                  <Column header="Personal Notes">
                    <template #body="slotProps">
                      <Button
                        @click="showNotes(slotProps.data.notes?.personal_notes)"
        ...
        <div class="col-span-1 lg:w-2/3">
          ...
          >
            <template #icon>
              ...
              <path d="M5.03737 13.7601C5.0214 13.5373 5.05149 13.3137 5.12577 13.103C5.20005 12.8924 5.31693 12.6993 5.46911 12.5358C5.6213 12.3724 5.80553 12.242 6.01032 12.1529C6.2151 12.0637 6.43606 12.0177 6.65941 12.0177H19.4276C19.6509 12.0177 19.8717 12.0637 20.0765 12.1528C20.2812 12.2419 20.4654 12.3722 20.6176 12.5356C20.7697 12.6989 20.8866 12.8919 20.961 13.1025C21.0353 13.313 21.0655 13.5366 21.0496 13.7593L19.656 33.2725C19.6268 33.6828 19.4433 34.0667 19.1423 34.3471C18.8413 34.6274 18.4453 34.7832 18.034 34.7832H8.05298C7.64169 34.7832 7.24567 34.6274 6.94469 34.3471C6.64372 34.0667 6.46014 33.6828 6.43094 33.2725L5.03737 13.7601Z" stroke="white" stroke-width="3"/>
              <path d="M13.0435 7.13939V3.88718C13.0435 3.45591 13.2148 3.04231 13.5197 2.73735C13.8247 2.4324 14.2383 2.26108 14.6696 2.26108H17.1087" stroke="white" stroke-width="3" stroke-linecap="round"/>
              <path d="M5.49987 8.49801C5.56316 8.11847 5.75901 7.77366 6.05257 7.5249C6.34614 7.27614 6.71841 7.13955 7.10321 7.1394H18.9835C19.3685 7.13936 19.7409 7.27586 20.0347 7.52464C20.3284 7.77342 20.5244 8.11833 20.5877 8.49801L21.1739 12.0177H4.91284L5.49987 8.49801Z" stroke="white" stroke-width="3"/>
          ...
          <div class="bg-white border border-gray-300 rounded-lg shadow-xl">
            ...
            <div
              class="my-3"
              v-for="(item, index) in callHistory.slice(0, 3)"
              :key="index"
            ...
            >
              <div class="mb-2 p-4">
                ...
                <span
                  class="inline-flex items-center rounded-md bg-primary px-2 py-1 text-[10px] font-medium text-white ring-1 ring-inset ring-primary"
                >
                  Office: {{ localAddress.country }}
                </span>
                <span
                  ...
                  <span class="font-bold">
                    {{
                      item.total_duration < 60
                        ...
                        : Math.floor(item.total_duration / 60) + ' Minutes ' + (item.total_duration % 60) + ' Seconds'
                    }}
                  </span>
                </span>
              </div>
            ...
            <div class="space-y-2">
              <div class="field">
                ...
                <DatePicker
                  ...
                  showTime
                  hourFormat="12"
                  placeholder="Follow up datetime"
                  fluid
                  v-model="localAddress.follow_up_date"
                  class="w-full !border-secondary"
                />
              </div>
            </div>
        ...
        <Dialog
          ...
          v-model:visible="showCallbackForm"
          modal
          class="rounded-lg shadow-lg"
          :style="{ width: '90%', maxWidth: '36rem' }"
        >

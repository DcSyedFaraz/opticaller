    ...
    <AuthenticatedLayout>
        <div class=" mx-auto ">
            ...
            <div class="flex mb-4">
                ...
                <Button @click="createUser" label="Create User" class="!bg-[#383838] !border-[#383838] !px-[3rem] !rounded" icon="pi pi-plus" />
            </div>
            <DataTable :value="users.data" responsiveLayout="scroll"
                ...
                <Column header="Actions" class="flex">
                    <template #body="slotProps">
                        <Button @click="editUser(slotProps.data.id)" icon="pi pi-pencil" class="p-link !bg-[#383838] !border-[#383838] mx-2" />

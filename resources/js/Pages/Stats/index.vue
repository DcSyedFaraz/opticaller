    ...
    <AuthenticatedLayout>
        ...
        <div class="p-6 bg-gray-100 min-h-screen">
                    ...
                    <div class="flex flex-col my-2 space-x-4 shadow-secondary  bg-white p-2 rounded-lg shadow">
                        ...
                        <div class="m-2 grid grid-cols-2">
                            <div class="grid grid-cols-1">
                                ...
                                <DatePicker v-model="startDate" iconPos="left" showIcon fluid placeholder="MM/DD/YY"
                                    class="w-full " />
                            </div>
                            <div class="grid grid-cols-1 mx-2">

                                <DatePicker v-model="endDate" iconPos="left" showIcon fluid placeholder="MM/DD/YY"
                                    class="w-full" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-primary text-white p-4 rounded-lg shadow  flex items-center justify-center flex-col">
                        <div class="grid grid-cols-2">
                            <div class="grid grid-cols-1 text-center">
                                ...
                                <p class="text-2xl font-bold">{{ topPerformer }}</p>
            ...
            <div class="bg-white p-4 rounded-lg shadow mt-6">
                <Toolbar>
                    <template #start>
                        <Button label="Copy" icon="pi pi-copy" class="p-button-outlined mr-2" />
                        <Button label="Excel" icon="pi pi-file-excel" class="p-button-outlined mr-2" />
                        <Button label="PDF" icon="pi pi-file-pdf" class="p-button-outlined" />
                    </template>
                    <template #end>
                        <Button label="Column visibility" icon="pi pi-eye" class="p-button-outlined" />
                    </template>
                </Toolbar>

                <DataTable :value="users" class="p-datatable-sm mt-4">
...
export default {
    data() {
        return {
            ...
            startDate: null,
            endDate: null,
            topPerformer: 'Dana White',
            loginTime: '10:15 am',
            successRate: 70,

            users: [
                { name: 'John Doe', position: 'Manager', office: 'New York', age: 35, startDate: '01/15/2015', salary: '$5000' },
                { name: 'Jane Smith', position: 'Developer', office: 'San Francisco', age: 29, startDate: '02/20/2018', salary: '$4000' },
                { name: 'Michael Johnson', position: 'Designer', office: 'Los Angeles', age: 40, startDate: '03/18/2010', salary: '$4500' },
    ...
    computed: {
        strokeDashoffset() {
            const progressValue = this.successRate;

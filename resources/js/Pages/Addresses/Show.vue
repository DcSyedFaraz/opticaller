        ...
        <div class="max-w-4xl mx-auto  sm:px-6 lg:px-8">
            ...
            <form @submit.prevent="updateAddress" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="col-span-1 sm:col-span-2 lg:col-span-3 mb-4">
                    ...
                    <InputText v-model="address.company_name" type="text" class="w-full" />
                ...
                <div class="mb-4">
                    ...
                    <InputText v-model="address.mobile_number" type="text" class="w-full" />
                ...
                <div class="mb-4">
                    ...
                    <ToggleSwitch v-model="address.forbidden_promotion" class="w-full" />
